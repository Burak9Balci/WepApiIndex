        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YaratılısTarihi = table.Column<DateTime>(name: "Yaratılıs Tarihi", type: "datetime2", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "ID", "AuthorID", "BookShelfID", "CategoryID", "Yaratılıs Tarihi", "DeletedDate", "EditorID", "ModifiedDate", "Name", "PageNumber", "Status", "UnitPrice" },
                values: new object[] { 1, null, null, null, new DateTime(2024, 6, 26, 18, 55, 23, 681, DateTimeKind.Local).AddTicks(5040), null, null, null, "Ateş ve Kan", null, 1, 0m });
